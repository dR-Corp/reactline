...
class Dashboard extends Component {
  ...
  getProduct = () => {
    ...
    axios.get(`https://openode.onrender.com/api/stuff${data}`, {
      headers: {
      ...
      this.setState({ loading: false, products: res.data, pages: 1 });
    }).catch((err) => {
      Swal.fire({
  ...
  // deleteProduct = (id) => {
  //   axios.post('https://openode.onrender.com/api/stuff', {
  //     id: id
  //   }, {
  //     headers: {
            ...
            <TableBody>
              {this.state.products.map((product) => (
                <TableRow key={`${product._id}-${product.title}`}>
                  ...
                  <TableCell align="center"><img src={`${product.imageUrl}`} width="70" height="70" /></TableCell>
                  ...
                  <TableCell align="center">
                    <Button
                      ...
                      color="primary"
                      size="small"
                      onClick={(e) => this.handleProductEditOpen(product)}
                    >
                      Edit
                  </Button>
                    <Button
                      ...
                      color="secondary"
                      size="small"
                      onClick={(e) => this.deleteProduct(product._id)}
                    >
                      Delete
                  </Button>
                  </TableCell>
